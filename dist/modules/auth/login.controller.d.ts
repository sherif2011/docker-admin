...
import { AuthClientRepository, RefreshTokenRepository, UserRepository, UserTenantPermissionRepository, UserTenantRepository, UserTenantClientRepository } from '../../repositories';
...
export declare class LoginController {
    ...
    utClientsRepo: UserTenantClientRepository;
    refreshTokenRepo: RefreshTokenRepository;
    constructor(client: AuthClient | undefined, user: AuthUser | undefined, getUserPermissions: UserPermissionsFn<string>, authClientRepository: AuthClientRepository, userRepo: UserRepository, userTenantRepo: UserTenantRepository, utPermsRepo: UserTenantPermissionRepository, utClientsRepo: UserTenantClientRepository, refreshTokenRepo: RefreshTokenRepository);
