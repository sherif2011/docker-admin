...
__decorate([
    ...
    loopback4_authorization_1.authorize(["CreateAnyUser" /* CreateAnyUser */, "CreateTenantUser" /* CreateTenantUser */]),
    rest_1.post('/users', {
        responses: {
            '200': {
...
__decorate([
    loopback4_authentication_1.authenticate("bearer" /* BEARER */),
    loopback4_authorization_1.authorize(["DeleteAnyUser" /* DeleteAnyUser */, "DeleteTenantUser" /* DeleteTenantUser */]),
    rest_1.del('/users/{id}', {
        responses: {
            '204': {
